...
export default function GalleryPageCTA() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="Imagine Your Celebration CTA"
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
          ...
          <p className="mt-6 text-slate-200 font-sans font-light text-base sm:text-lg md:text-xl leading-relaxed">
            Let our manicured lawns, sparkling private swimming pool, and royal decor set the stage for your dream wedding, birthday bash, or anniversary.
          </p>
          ...
          <div className="mt-8 flex flex-wrap justify-center items-center gap-6 text-xs text-slate-300 font-sans font-light">
            <span>✨ Instant Venue Visits</span>
            <span>•</span>
            <span>📍 Prime Jaipur Location</span>
            <span>•</span>
            <span>📞 Direct Event Support</span>
          </div>
