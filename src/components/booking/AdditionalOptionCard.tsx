  ...
  return (
    <div className="my-10 pt-8 border-t-2 border-dashed border-[var(--accent)]/40">
      ...
      <div className="text-center max-w-xl mx-auto mb-8">
        ...
        <p className="mt-3 text-xs sm:text-sm text-slate-600 font-sans max-w-md mx-auto">
          यह सुविधा ₹41,000/- की मूल गार्डन बुकिंग से अलग है। आवश्यकतानुसार इसे
          अतिरिक्त विकल्प के रूप में जोड़ा जा सकता है।
        </p>
      </div>
      ...
      <div className="bg-gradient-to-br from-[var(--primary-dark)] to-[#091B13] rounded-3xl p-6 sm:p-8 text-white shadow-2xl border border-[var(--accent)]/30 overflow-hidden relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center relative z-10">
          ...
          <div className="md:col-span-7 space-y-4">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              मूल ₹41,000/- गार्डन बुकिंग के अतिरिक्त यदि आप विशेष सुविधाएं
              लेना चाहते हैं, तो ₹10,000/- अतिरिक्त शुल्क देकर इस प्रीमियम
              पैकेज को जोड़ा जा सकता है। इसके अतिरिक्त ₹1,500/- का शुल्क
              लागू होगा।
            </p>

            {/* Clear Price Breakdown */}
            <div className="p-4 rounded-xl bg-white/5 border border-white/10 space-y-3 text-xs sm:text-sm">

              {/* Base Price */}
              <div className="flex justify-between items-center pb-3 border-b border-white/10 gap-4">
                <span className="text-slate-300">
                  मूल गार्डन बुकिंग मूल्य:
                </span>

                <span className="font-serif font-bold text-white text-base whitespace-nowrap">
                  ₹41,000/-
                </span>
              </div>
              ...
              <div className="flex justify-between items-center pt-1 gap-4">
                ...
                <span className="font-serif font-extrabold text-xl text-[var(--accent-light)] whitespace-nowrap">
                  ₹52,500/-
                </span>
              </div>
